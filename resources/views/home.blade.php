    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <a href="/" class="flex items-center gap-2.5 flex-shrink-0">
                ...
                <span class="text-xl font-bold text-white">{{ explode(' ', $appName)[0] }}<span class="text-grad">Sphere</span></span>
            </a>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
                ...
                <div class="glass rounded-xl p-4 mt-4">
                    <div class="text-xs text-gray-400 mb-2">Download App</div>
                    <div class="flex flex-col gap-2">
                        <a href="#" class="bg-white/10 hover:bg-white/20 transition-colors text-white text-xs font-semibold px-3 py-2 rounded-lg text-center"> App Store</a>
                        <a href="#" class="bg-white/10 hover:bg-white/20 transition-colors text-white text-xs font-semibold px-3 py-2 rounded-lg text-center"> Google Play</a>
                    </div>
                </div>
            </div>
        </div>
