...
<div class="space-y-2 mb-6">
    @if(session('success'))
    <div class="flex items-center gap-3 rounded-2xl bg-emerald-500/10 border border-emerald-500/25 px-4 py-3 text-sm text-emerald-300">
    ...
    @endif
    @if(session('error'))
    <div class="flex items-center gap-3 rounded-2xl bg-red-500/10 border border-red-500/25 px-4 py-3 text-sm text-red-300">
    ...
    @endif
    @if(session('warning'))
    <div class="flex items-center gap-3 rounded-2xl bg-amber-500/10 border border-amber-500/25 px-4 py-3 text-sm text-amber-300">
    ...
    @endif
    @if(session('info'))
    <div class="flex items-center gap-3 rounded-2xl bg-blue-500/10 border border-blue-500/25 px-4 py-3 text-sm text-blue-300">
